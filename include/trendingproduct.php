                      ...
                      <div class="product-item">
                        ...
                        <figure>
                          <a href="index.php" title="Product Title">
                            <img src="./Admin/uploads/images/products/<?=$product['image']?>"  class="<?=$product['image']?>">
                          </a>
                        </figure>
                        <h3><?=$product['name']?></h3>
                        ...
                        <div class="d-flex align-items-center justify-content-between">
                          <form method="post">
                            <div class="input-group product-qty">
                                <span class="input-group-btn">
                                    ...
                                    <button type="submit" name="minus" class="quantity-left-minus btn btn-danger btn-number" data-type="minus">
                                ...
                                <span class="input-group-btn">
                                    <input type="hidden" name="product_id" value="<?=$product['product_id']?>" />
                                    <button type="submit" name="add" class="quantity-right-plus btn btn-success btn-number" data-type="plus">
                          ...
                          <form action="" method="post">
                            <input type="hidden" name="product_id" value="<?=$product['product_id']?>">
                            <input type="submit" name="add_to_cart" value="Add to Cart" class="nav-link" />
                          </form>
